...
const INSTAGRAM_URL =
  "https://www.instagram.com/eugeny_nickolaevich?igsh=czJweWdtcnl5MXl0";
const INSTAGRAM_HANDLE = "@eugeny_nickolaevich";
const EMAIL = "eugeny.nickolaevich.v@yandex.ru";

const linkClass =
  "inline-flex max-w-full items-start gap-2 text-sm text-zinc-400 transition-colors hover:text-zinc-100";
  ...
  return (
    ...
    >
      ...
      <a href={`mailto:${EMAIL}`} className={linkClass}>
        ...
        <span className="min-w-0 break-all text-xs sm:text-sm">{EMAIL}</span>
      </a>
    </div>
  );
}
